...
function commentPro(num) {
    ...
    $.get("${pageContext.request.contextPath}/board2/board2CommentPro?comment=" + comment + "&num=" + num,  
        ...
        function (data, status) {
            ...
            console.log("Data: " + data + "\nStatus: " + status);
            let commentList = document.querySelector("#commentList");
            // data + commentList.innerHTML;: 서버로부터 받은 데이터 (data)를 댓글 목록의 HTML 내용 앞에 추가합니다. 이로써 새로 작성된 댓글이 목록의 맨 위에 추가됩니다.
            commentList.innerHTML = data + commentList.innerHTML;
        ...
        <tr>
            <td colspan="4">                                                                                    
                <p class="d-flex justify-content-end">
                    <input type="button" value="글수정" onclick="document.location.href='${pageContext.request.contextPath}/board2/board2UpdateForm?num=${board2.num}'" class="btn btn-primary board-button" />
