...
<div class="container mt-5 mb-5">
    <div class="row">
        <div class="col-md-4 col-sm-12">
            <div class="card mb-3">
                <img src="${pageContext.request.contextPath}/images/coco1.jpg" class="card-img-top" alt="..." width="50px">
                <div class="card-body">
        ...
        <div class="col-md-4 col-sm-12">
            <div class="card mb-3">
                <img src="http://image.dongascience.com/Photo/2020/03/5bddba7b6574b95d37b6079c199d7101.jpg" class="card-img-top" alt="...">
                <div class="card-body">
                    <h5 class="card-title text-center">진수 운영진님의 반려동물 코코</h5>
                    <p class="card-text">코코는 사랑스러워요</p>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-4 col-sm-12">
            <div class="card mb-3">
                <img src="http://image.dongascience.com/Photo/2020/03/5bddba7b6574b95d37b6079c199d7101.jpg" class="card-img-top" alt="...">
                <div class="card-body">
                    <h5 class="card-title text-center">진박 운영진님의 반려동물 코코</h5>
                    <p class="card-text">코코는 잠꾸러기에요</p>
                </div>
            </div>
        </div>
    </div>
     ...
     <div class="row">
        <div class="col-md-4 col-sm-12">
            <div class="card mb-3">
                <img src="${pageContext.request.contextPath}/images/coco2.jpg" class="card-img-top" alt="..." width="50px">
                <div class="card-body">
                    <h5 class="card-title text-center">진수 운영진님의 반려동물 코코</h5>
