...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
  ...
  <ul class="navbar-nav me-auto mb-2 mb-lg-0">
	...
	<li><a class="dropdown-item" href="${pageContext.request.contextPath}/board2/board2List">정보 &amp;공유게시판</a></li>  
		<li><a class="dropdown-item"href="${pageContext.request.contextPath}/board3/board3List?boardid=3">친구 찾기(오픈예정)</a></li>
      </ul>
    </li>
    
  
    <li class="nav-item">
      <a href="${pageContext.request.contextPath}/api/maps" class="nav-link"  onmouseover="changeWord(this, ['병원 정보', 'Hospital information'])">Hospital&Hotel&Beauty</a>
    </li>
